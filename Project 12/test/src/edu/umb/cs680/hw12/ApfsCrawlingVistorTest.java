...
import edu.umb.cs680.hw12.ApfsCrawlingVistor;
...
public class ApfsCrawlingVistorTest  {
    ...
    @Test
    void testApfsCrawlingVistor() {
        ApfsCrawlingVistor vistor = new ApfsCrawlingVistor();
        root.accept(vistor);
        int actual = vistor.getFiles().size();
        int expected = 6;
